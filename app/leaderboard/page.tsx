      ...
      {leaderboard.map(pkmn => (
        <div className="flex border border-neutral-900" key={pkmn.dexNumber}>
          ...
          <div className="p-4 w-[200px] md:w-[250px] flex flex-col items-center justify-center">
            <h2 className="scroll-m-20 pb-2 text-xl md:text-3xl font-semibold tracking-tight">{pkmn.name.slice(0, 20)} <span className="text-neutral-400 text-lg md:text-2xl">#{pkmn.dexNumber}</span></h2>
